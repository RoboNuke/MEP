...
from mani_skill.utils.wrappers.flatten import FlattenActionSpaceWrapper, FlattenObservationWrapper
...
class Args:
    ...
    # extras
    with_MEP_wrapper: bool = True
    """ to use the manipulability ellipsoid wrapper """
...
if __name__ == "__main__":
    ...
    if args.with_MEP_wrapper:
        print("\n\n")
        print("Using manipulablity wrapper")
        print("\n\n")
        envs = ManipulabilityEllipsoidObservationWrapper(envs)
        eval_envs = ManipulabilityEllipsoidObservationWrapper(eval_envs)
